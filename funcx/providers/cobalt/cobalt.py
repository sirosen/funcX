...
from funcx.providers.cobalt.template import template_string
...
class CobaltProvider(ClusterProvider, RepresentationMixin):
    ...
    def submit(self, command, tasks_per_node, job_name="parsl.cobalt", redis=None):
        ...
        # Wrap the command
        job_config["user_script"] = self.launcher(command, tasks_per_node, self.nodes_per_block, redis=redis)
